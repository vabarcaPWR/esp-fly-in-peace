...
{
    active_led_state = LED_STATE_BOOT;
    return ESP_OK;
}
...
#define LED_PATTERN_DISCONNECTED_PERIOD_TICKS 39U
#define LED_PATTERN_CONNECTED_PERIOD_TICKS 159U
#define LED_PATTERN_WIFI_PERIOD_TICKS 20U
#define LED_PATTERN_ERROR_PERIOD_TICKS 20U
...
static const led_t led_single_driver = {
